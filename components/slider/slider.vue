<template>
  <view class="c-slider" :style="{height:blockSize+'px', width:realWidth+'px'}">
    <view class="c-slider-bar" :style="{background:bgColor, width:realWidth+'px', height:height+'px'}"></view>
    <view class="c-slider-active-bar" :style="{background:activeColor, width:activeWidth+'px', height:height+'px', marginLeft:activeLeft+'px'}"></view>
    <!--    <view class="c-slider-block" :style="{background:blockBgColor, height:blockSize+'px', width:blockSize+'px', 'margin-left':xMin+'px'}"
      @touchstart.stop="touchstart" @touchmove.stop="touchmove" data-tag="min"></view> -->
    <view class="c-slider-block" :style="{background:blockBgColor, height:blockSize+'px', width:blockSize+'px', 'margin-left':xMax+'px'}"
      @touchstart.stop="touchstart" @touchmove.stop="touchmove" @touchend.stop="touchend" data-tag="max"></view>
  </view>
</template>
<script>
